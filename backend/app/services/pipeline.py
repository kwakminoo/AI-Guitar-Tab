...
def _select_midi_source_stem(
    ...
    if not guitar_stem_mp3 and stems.get("other") and stems["other"].is_file():
        return "guitar", _ensure_flat_guitar_stem_mp3(stems, stems_root), "guitar/piano 누락 또는 무효 -> other stem fallback"
