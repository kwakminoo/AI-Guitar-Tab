...
def _select_midi_source_stem(
    ...
    if (not guitar_stem_mp3 or not guitar_stem_mp3.is_file()) and other_stem_mp3 and other_stem_mp3.is_file():
        return (
            "guitar",
            _ensure_flat_guitar_stem_mp3(stems, stems_root),
            "guitar/piano stem 누락 또는 무효 -> other stem을 guitar fallback으로 사용",
        )

    return "fallback", mix_mp3, "guitar/piano 모두 무효 또는 누락 -> mix(source.mp3) fallback"
