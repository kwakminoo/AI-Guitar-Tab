 ...
 */
export const TEST_SCORE_DISPLAY_TITLE = "Sasha Sloan-Dancing With Your Ghost";

/** src 기준: frontend/src/ 아래 상대 경로 조각 */
export const TEST_SCORE_REL_SEGMENTS = ["test-scores", "Sasha Sloan-Dancing With Your Ghost", "dancing-with-your-ghost.atex"] as const;

/** 브라우저가 직접 요청하는 폴백: frontend/public/test-scores/<이름> */
export const TEST_SCORE_PUBLIC_FILE = "dancing-with-your-ghost.atex";
