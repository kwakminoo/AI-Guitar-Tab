 ...
 */
export const TEST_SCORE_DISPLAY_TITLE = "백아-첫사랑";

/** src 기준: frontend/src/ 아래 상대 경로 조각 */
export const TEST_SCORE_REL_SEGMENTS = ["test-scores", "백아-첫사랑", "baek-a-first-love.atex"] as const;

/** 브라우저가 직접 요청하는 폴백: frontend/public/test-scores/<이름> */
export const TEST_SCORE_PUBLIC_FILE = "baek-a-first-love.atex";
